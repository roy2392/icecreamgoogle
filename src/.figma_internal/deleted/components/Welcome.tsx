  ...
  return (
    <div className="relative h-screen h-[100dvh] overflow-hidden flex items-center justify-center text-white w-full" dir="rtl">
      ...
      <div className="flex flex-col h-full w-full z-10">
        {/* Top Section - Logo */}
        <motion.div 
          className="flex-1 flex flex-col justify-center items-center text-center px-6 md:px-8 pt-8"
          ...
          >
            <div className="flex flex-col items-center gap-4">
              <ImageWithFallback 
                src={logoImage} 
                alt="Next AICream" 
                className="w-60 sm:w-72 md:w-80 lg:w-96 xl:w-[28rem] max-w-full mx-auto drop-shadow-2xl"
              />
        ...
        <motion.div 
          className="h-[38%] md:h-[35%] relative rounded-t-[2.5rem] px-8 md:px-10 py-8 md:py-10 flex flex-col justify-between backdrop-blur-xl"
        ...
        >
          ...
          >
            <motion.h1 
              className="text-xl sm:text-2xl md:text-3xl lg:text-4xl mb-2 max-w-sm md:max-w-md lg:max-w-lg mx-auto leading-relaxed bg-gradient-to-l from-white via-white to-white/90 bg-clip-text text-transparent font-medium"
              animate={{ 
            ...
            <motion.p 
              className="text-sm sm:text-base md:text-lg lg:text-xl text-gray-200 max-w-xs md:max-w-sm lg:max-w-md mx-auto leading-relaxed"
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
          ...
          >
            ...
            >
              <Button 
                onClick={onStart}
                className="w-full bg-gradient-to-r from-[#FD5109] to-[#FF6B20] hover:from-[#E04300] hover:to-[#FF5500] text-white py-6 sm:py-7 md:py-8 lg:py-9 text-lg sm:text-xl md:text-2xl lg:text-3xl rounded-3xl shadow-2xl shadow-[#FD5109]/25 border border-white/10 backdrop-blur-sm relative overflow-hidden group"
              >
                <motion.div
